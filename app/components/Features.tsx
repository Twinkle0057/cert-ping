  ...
  const features = [
    {
      ...
      description: "SSL certificates continuously checked",
      number: "10,000+",
      svg: `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-globe ml-auto h-5 w-5 text-blue-500">
                  <circle cx="12" cy="12" r="10"></circle>
                  <path d="M12 2a14.5 14.5 0 0 0 0 20 14.5 14.5 0 0 0 0-20"></path>
                  <path d="M2 12h20"></path>
                </svg>`,
      svgClass: "lucide lucide-globe ml-auto h-5 w-5 text-blue-500"
    },
    {
      title: "SSL Issues Detected",
      description: "Expired or misconfigured certificates identified",
      number: "500+",
      svg: `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-triangle-alert ml-auto h-5 w-5 text-yellow-500">
                  <path d="m21.73 18-8-14a2 2 0 0 0-3.48 0l-8 14A2 2 0 0 0 4 21h16a2 2 0 0 0 1.73-3"></path>
                  <path d="M12 9v4"></path>
                  <path d="M12 17h.01"></path>
                </svg>`,
      svgClass: "lucide lucide-triangle-alert ml-auto h-5 w-5 text-yellow-500"

    },
    {
      title: "Alerts Sent",
      description: "Timely notifications for certificate problems",
      number: "5000+",
      svg: `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-zap ml-auto h-5 w-5 text-purple-500">
                  <path d="M4 14a1 1 0 0 1-.78-1.63l9.9-10.2a.5.5 0 0 1 .86.46l-1.92 6.02A1 1 0 0 0 13 10h7a1 1 0 0 1 .78 1.63l-9.9 10.2a.5.5 0 0 1-.86-.46l1.92-6.02A1 1 0 0 0 11 14z"></path>
                </svg>`,
      svgClass: "lucide lucide-zap ml-auto h-5 w-5 text-purple-500"
    ...
    },
    {
      ...
      number: "99.9%",
      svg: `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-shield-check ml-auto h-5 w-5 text-green-500">
                  <path d="M20 13c0 5-3.5 7.5-7.66 8.95a1 1 0 0 1-.67-.01C7.5 20.5 4 18 4 13V6a1 1 0 0 1 1-1c2 0 4.5-1.2 6.24-2.72a1.17 1.17 0 0 1 1.52 0C14.51 3.81 17 5 19 5a1 1 0 0 1 1 1z"></path>
                  <path d="m9 12 2 2 4-4"></path>
                </svg>`,
      svgClass: "lucide lucide-shield-check ml-auto h-5 w-5 text-green-500"
      ...
      <div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-12  max-w-7xl mx-auto">
          {features.map((feature, index: number) => (
            <FeatureItem key={index} title={feature.title} description={feature.description} n={feature.number} svg={feature.svg} svgClass={feature.svgClass}></FeatureItem>
          ))}
        </div>
